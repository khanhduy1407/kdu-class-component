/**
  * kdu-class-component v8.0.0-alpha.6
  * (c) 2022 NKDuy
  * @license MIT
  */
var KduClassComponent = (function (exports, kdu) {
  'use strict';
  ...
  var KduImpl = /*#__PURE__*/function () {
    function KduImpl(props, ctx) {
      var _this = this;

      _classCallCheck(this, KduImpl);
    ...
    _createClass(KduImpl, null, [{
      ...
      get: function get() {
        ...
        options.setup = function (props, ctx) {
          ...
          var plainData = kdu.reactive({}); // Initialize reactive data and convert constructor `this` to a proxy
  ...
  KduImpl.__vccHooks = ['data', 'beforeCreate', 'created', 'beforeMount', 'mounted', 'beforeUnmount', 'unmounted', 'beforeUpdate', 'updated', 'activated', 'deactivated', 'render', 'errorCaptured', 'serverPrefetch'];
  var Kdu = KduImpl;
  ...
  function mixins() {
    ...
    return _a = /*#__PURE__*/function (_Kdu) {
      _inherits(MixedKdu, _Kdu);

      var _super = _createSuper(MixedKdu);

      function MixedKdu(props, ctx) {
        var _this;

        _classCallCheck(this, MixedKdu);
      ...
      return MixedKdu;
    }(Kdu), _a.__vccMixins = Ctors.map(function (Ctor) {
