...
export function componentFactory (
  Component: KduClass<Kdu>,
  options: ComponentOptions<Kdu> = {}
): KduClass<Kdu> {
  ...
  // add data hook to collect class properties as Kdu instance's data
  ;(options.mixins || (options.mixins = [])).push({
    data (this: Kdu) {
  ...
  const Super = superProto instanceof Kdu
    ? superProto.constructor as KduClass<Kdu>
    : Kdu
  ...
  Object.getOwnPropertyNames(Original).forEach(key => {
    ...
    if (
      ...
      warn(
        ...
        'conflicts with reserved property name of Kdu internal. ' +
